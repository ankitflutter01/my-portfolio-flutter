...
List<ExperienceModel> experienceList = [
  ExperienceModel(
    ...
    organization: 'Knovos India PVT.',
    duration: 'March 2024 - Present',
    description: '- As a Flutter Developer at Knovos India, I have contributed to the development of two key products, focusing on delivering high-quality mobile applications for clients.\n- Throughout my tenure, I have gained hands-on experience in Flutter best practices, optimizing app performance, integrating REST APIs, and utilizing Firebase services. My focus has been on building scalable, maintainable applications that enhance user experience and meet business objectives. ',
  ),
  ExperienceModel(
    role: 'SoftWare Developer',
    organization: 'TriState Technology',
    duration: 'Jan 2022 - March 2024',
    description: '- Implement quality and on time solution to align with business requirements.\n- Conduct full life cycle software development from planning to deployment and maintenance.\n- Build intuitive, engaging and progressive user interaction for mobile appsIn this organization,\n- I have been a part of 16+ mobile app projects.',
  ),
